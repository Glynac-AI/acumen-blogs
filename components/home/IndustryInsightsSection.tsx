...
import { getIndustryInsightsArticles } from '@/lib/mock-data';

export const IndustryInsightsSection: React.FC = () => {
    const insightsArticles = getIndustryInsightsArticles(7); // Get 7 articles for asymmetric layout

    // Split articles: 1 featured + 6 regular
    const featuredArticle = insightsArticles[0];
    const regularArticles = insightsArticles.slice(1);
